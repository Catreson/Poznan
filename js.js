...
// hack na podpiecie sie do istniejacego websocketa
    ...
    document.getElementById("speedhive_iframe").contentWindow.sockets = [];
    WebSocket.prototype.send = function(...args) {
      if (document.getElementById("speedhive_iframe").contentWindow.sockets.indexOf(this) === -1) {
        document.getElementById("speedhive_iframe").contentWindow.sockets.push(this);
        ws = this;
